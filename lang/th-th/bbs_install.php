...
return array(
	...
	'license_title' => 'ข้อตกลง Xiuno PRO',
...
Xiuno PRO ใช้งาน Bootstrap 4 + jQuery 3 เป็นไลบราลีระบบหน้าบ้าน รองรับเบราว์เซอร์มือถือเต็มรูปแบบ และระบบหลังบ้านมีการใช้งาน XiunoPHP 4.0 รองรับ NoSQL เป็นช่องทางการทำงานกับฐานข้อมูลที่หลากหลาย เวอร์ชันนี้เป็นก้าวใหญ่ที่สำคัญของเรา
...
Xiuno BBS 4 ใช้งานข้อตกลง MIT คุณสามารถแก้ไขได้อย่างอิสระ เปลี่ยนแปลงเวอร์ชัน หรือใช้งานในเชิงพาณิชย์ได้โดยไม่ต้องกังวลในทางกฎหมายใด ๆ (ควรเก็บข้อมูลลิขสิทธิ์เดิมไว้)
	...
	'install_title' => 'ตัวช่วยติดตั้ง Xiuno PRO',
