...
Xiuno PRO 采用 Bootstrap 4 + JQuery 3 作为前端类库，全面支持移动端浏览器；后端 XiunoPHP 4.0 支持了 NoSQL 的方式操作各种数据库，这个版本是一个巨大的飞跃。
	
Xiuno 发音“修罗”，英文为 Shura，在佛教里面为六道之一"修罗道"，处于人道和天道之间。

Xiuno PRO 采用 MIT 协议发布，您可以自由修改、派生版本、商用而不用担心任何法律风险（修改后应保留原来的版权信息）。',
	'license_date' => '发布时间：2021年11月15日',
	'agree_license_to_continue' => '同意协议继续安装',
	'install_title' => 'Xiuno PRO 安装向导',
	'install_guide' => '安装向导',
